...
@Component({
  selector: 'app-Add-distibutor',
  templateUrl: './add-distibutor.component.html',
  styleUrls: ['./add-distibutor.component.css']
})
export class AddDistibutorComponent implements OnInit {
